...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
       <form action="{{ url('/savepenghapusan') }}" method="post">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="number" id='jumlah_hapus' name="jumlah_hapus" class="form-control" required>
        </div>
        <div class="form-group row">
            <div class="col-md-6">
                <label for="kondisi">Kondisi</label>
                <select class="form-control" id="kondisi" name="kondisi" required>
                    <option value="0">Dibuang</option>
