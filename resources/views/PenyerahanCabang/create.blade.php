...
@section('content')
<h1 class="h3 mb-2 text-gray-800">Tambah Penyerahan Cabang</h1>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Form Tambah Penyerahan Cabang</h6>
    </div>
    <div class="card-body">
       <form action="{{ url('/savepenyerahancabang') }}" method="post">
        @csrf
